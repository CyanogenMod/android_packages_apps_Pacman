...
//		Set the length of the array to the number of checkboxes initialized;
		...
		mGmail.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[0] = "market://search?q=pname:com.google.android.gm";
				} else {
					mApps[0] = null;
				}
			}
		...
		mChromeToPhone.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[1] = "market://search?q=pname:com.google.android.apps.chrometophone";
				} else {
					mApps[1] = null;
				}
			}
		...
		mGoogleGoggles.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[2] = "market://search?q=pname:com.google.android.apps.unveil";
				} else {
					mApps[2] = null;
				}
			}
		...
		mGoogleMaps.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[3] = "market://search?q=pname:com.google.android.apps.maps";
				} else {
					mApps[3] = null;
				}
			}
		...
		mGoogleSearch.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[4] = "market://search?q=pname:com.google.android.googlequicksearchbox";
				} else {
					mApps[4] = null;
				}
			}
		...
		mGoogleVoice.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[5] = "market://search?q=pname:com.google.android.apps.googlevoice";
				} else {
					mApps[5] = null;
				}
			}
		...
		mStreetView.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[6] = "market://search?q=pname:com.google.android.street";
				} else {
					mApps[6] = null;
				}
			}
		...
		mVoiceSearch.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[7] = "market://search?q=pname:com.google.android.voicesearch";
				} else {
					mApps[7] = null;
				}
			}
		...
		mYoutube.setOnCheckedChangeListener(new OnCheckedChangeListener(){
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
				if(isChecked){
					mApps[8] = "market://search?q=pname:com.google.android.youtube";
				} else {
					mApps[8] = null;
				}
			}
